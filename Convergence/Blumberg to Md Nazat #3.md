...
“Both papers are information‑theoretic in spirit. Nazat’s paper takes entanglement as fundamental; SIT takes coherence/information as fundamental.”


“We do not equate information, entropy, and entanglement; these are distinct but related constructs (e.g., entanglement entropy is an entropy measure of entanglement).”
...
Ask for stronger, in‑text attribution where overlap occurs.
...
Focus on novelty criteria, not credentials.
...
Create a short “What’s new in SIT” figure/box for your own preprint/website.
...
Channel the tone (avoid ad hominem).
...
Clarity: statements are precisely defined and logically coherent.


Empirical correspondence: the theory connects to measurable quantities.


Falsifiability: it offers predictions that could, in principle, be proven wrong.


Reproducibility: others can check the reasoning or the data.
...
Expert fallacy (appeal to authority): claiming that only accredited experts can produce valid science substitutes authority for argument.


Genetic fallacy: judging a theory by its origin (who wrote it, or where) rather than by its content.


Ad hominem fallacy: rejecting an argument because of who made it.


Circularity: “It isn’t science because it’s not in a scientific journal; it’s not in a journal because it isn’t science.”
